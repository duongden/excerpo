...
* **Cơ chế tải ngầm an toàn:** Hỗ trợ phân giải DOM linh hoạt dựa trên kiến trúc mới nhất của các web truyện, tích hợp fallback khi web bất ngờ thay đổi giao diện.
